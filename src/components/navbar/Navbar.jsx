...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-purple-300 p-4 w-full flex justify-center items-center ">
      ...
      <div className="bg-purple-300 p-4 w-full flex items-center justify-center mx-auto">
